...
Source Database: turtleadmin
Date: 2020/8/8 14:08:39
*/
...
CREATE TABLE `fa_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='管理员日志表';
...
CREATE TABLE `fa_user` (
  ...
  `hbakey` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '火币a秘钥',
  `hbskey` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '火币s秘钥',
  `createtime` int(10) DEFAULT NULL COMMENT '创建时间',
...
--  Records 
-- ----------------------------
INSERT INTO `fa_admin` VALUES ('1','admin','Admin','b9a4122bd6c0d87d428a668832ecb8a9','82f20c','/assets/img/avatar.png','admin@admin.com','0','1596588445','127.0.0.1','1492186163','1596588445','63218553-fb6a-4695-94f7-aa530b293326','normal');
INSERT INTO `fa_admin_log` VALUES ('1','1','admin','/admin.php/index/login?url=%2Fadmin.php','登录','{\"url\":\"\\/admin.php\",\"__token__\":\"dad62eed14186adcbde8c66336c6dff0\",\"username\":\"admin\",\"keeplogin\":\"1\"}','127.0.0.1','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Safari/537.36','1596588304'), ('2','1','admin','/admin.php/index/login','登录','{\"__token__\":\"8b8f00af8bff20fb51236bb50f107c80\",\"username\":\"admin\"}','127.0.0.1','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Safari/537.36','1596588322'), ('3','1','admin','/admin.php/index/login?url=%2Fadmin.php%2Findex%2Flogout','登录','{\"url\":\"\\/admin.php\\/index\\/logout\",\"__token__\":\"268c4fd4299056427765fab59553358f\",\"username\":\"admin\",\"keeplogin\":\"1\"}','127.0.0.1','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Safari/537.36','1596588441'), ('4','1','admin','/admin.php/index/login','登录','{\"__token__\":\"dac58fb28ab6116dc354ce9f037194e7\",\"username\":\"admin\"}','127.0.0.1','Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Safari/537.36','1596588445');
INSERT INTO `fa_attachment` VALUES ('1','1','0','/assets/img/qrcode.png','150','150','png','0','21859','image/png','','1499681848','1499681848','1499681848','local','17163603d0263e4838b9387ff2cd4877e8b018f6'), ('2','0','6','/uploads/20200805/2243dc46b15c8b2e3f6d348153cf427a.jpg','640','640','jpg','0','41225','image/jpeg','','1596594163','1596594163','1596594163','local','6cb2c7ea863b916e90dfe8ea3d077ad6992f566a'), ('3','0','7','/uploads/20200808/2243dc46b15c8b2e3f6d348153cf427a.jpg','640','640','jpg','0','41225','image/jpeg','','1596866417','1596866417','1596866417','local','6cb2c7ea863b916e90dfe8ea3d077ad6992f566a');
...
INSERT INTO `fa_user` VALUES ('1','1','admin','c13f62012fd6a8fdf06b3452a94430e5','rpR6Bv','13888888888','','0.00','','','0',NULL,'normal'), ('2','0','bufeetu','2ef7f60bb13a5850068f55723a27f97b','VDzRFv','15664333798','','0.00','','','1596588648',NULL,'normal'), ('7','0','巴菲兔','6a221bef625c81a95c6c9bb6616e7060','123456','13212341234','/uploads/20200808/2243dc46b15c8b2e3f6d348153cf427a.jpg','0.00','bf1f83a8-dqnh6tvdf3-98559435-989c1','78527827825925498','1596850006','1596866567','normal');
...
INSERT INTO `fa_user_token` VALUES ('60c61591e20ab5e092f7ff38bcc5cf46b0e00b31','6','1596590834','1599182834'), ('66382bef51bfa32885dfcd6d4e22a2090c46d07c','6','1596593387','1599185387'), ('808563a2bdfdd96798e7e318eb346ee0aff08d1b','4','1596590515','1599182515'), ('94aa3e08c33ad75eb5022e1879bdb709280b1496','6','1596593341','1599185341'), ('d66132e5c7d3bb3f22ed1adacdc9e13b354171cc','5','1596590761','1599182761'), ('ebc387f78ff0dd614293d4dfcb84f677edc4db99','7','1596866193','1599458193');
