<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"P:\www\turtleadmin\public/../application/admin\view\user\add.html";i:1596867823;s:61:"P:\www\turtleadmin\application\admin\view\layout\default.html";i:1588765311;s:58:"P:\www\turtleadmin\application\admin\view\common\meta.html";i:1588765311;s:60:"P:\www\turtleadmin\application\admin\view\common\script.html";i:1588765311;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-hbakey" class="form-control" name="row[hbakey]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Hbskey'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-hbskey" class="form-control" name="row[hbskey]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
